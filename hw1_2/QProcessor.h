...
// Tue Mar 30 23:21:33 2021 by ROOT version 6.23/01
...
#ifdef QProcessor_cxx
QProcessor::QProcessor(TTree *tree) : fChain(0) 
{
...
Int_t QProcessor::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t QProcessor::LoadTree(Long64_t entry)
{
...
void QProcessor::Init(TTree *tree)
{
...
void QProcessor::Show(Long64_t entry)
{
...
Int_t QProcessor::Cut(Long64_t entry)
{
